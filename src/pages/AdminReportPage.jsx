...
// import { ChevronDown, ChevronUp, GraduationCap, Calendar, Download, Search, X, UserMinus } from "lucide-react";
...
//         // Fetch dropout rates for each batch based on the API in your screenshot
//         const mergedData = await Promise.all(batches.map(async (batch) => {
//           const dateInfo = dateMapping.find(d => d.batchId === batch.batchId);
//           let dropoutRate = 0;
//           try {
//             const dropRes = await api.getCourseDropout(batch.batchId);
//             dropoutRate = dropRes.dropoutRate || 0;
//           } catch (e) {
...
//                 <div className="flex items-center justify-end gap-8 w-[50%]">
...
//                   </div>
//                   {/* Drop Out Metric Added Here */}
//                   <div className="text-center min-w-[80px]">
//                     <div className="flex items-center justify-center gap-1">
//                       <UserMinus size={10} className="text-rose-500" />
//                       <p className="text-[8px] text-slate-500 uppercase">Drop Out</p>
//                     </div>
//                     <p className="text-2xl font-black text-rose-500">{batch.dropoutRate}</p>
//                   </div>
