  ...
  const handlePlaceholderClick = (e, page) => {
    ...
    Swal.fire({
      ...
      customClass: {
        ...
        confirmButton:
          "px-6 py-2 rounded-xl font-bold uppercase tracking-widest text-xs",
      },
    });
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed max-w-xs">
              Engineering institutional excellence with integrated LMS and Data
              Analytics infrastructure for the modern era.
            </p>
            <a
          ...
          <div className="lg:col-span-2 space-y-5">
            <h3 className="text-[11px] font-semibold text-white tracking-[0.01em] mb-7">
              Company
            </h3>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex gap-6">
            <a
              ...
              className="text-[9px] font-bold !text-slate-500 uppercase tracking-[0.15em] hover:!text-white transition-all !no-underline"
            >
              Privacy Policy
            </a>
            <a
